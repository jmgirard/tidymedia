...
This outlines how to propose a change to tidymedia. For more detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("jmgirard/tidymedia", fork = TRUE)`.
...
Code of
Conduct](https://jmgirard.github.io/tidymedia/CODE_OF_CONDUCT.md). By
