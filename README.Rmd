...
2. Run `tidymedia::install_on_win()` in R and confirm the prompt, which names the archive it will download, the directory it will unpack into, and the program locations it will overwrite.
