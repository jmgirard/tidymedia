...
|---|---|---|---|---|---|
| M35 | `audio_codec` for the four re-encode verbs (crop/segment/compare/pip + batch) — stream-copy by default | review | — | normal | milestones/M35-audio-codec-reencode-verbs.md |
