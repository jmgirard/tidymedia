...
_Last hygiene check: 2026-07-26 (/cairn-init repair cleared 2 scaffold/reference FAILs + 1 WARN; cairn_validate all green)_

## Milestones

| ID | Title | Status | Depends on | Priority | File/Archive |
|---|---|---|---|---|---|
| M32 | Batch siblings for the fan-in verbs (`concatenate_videos`/`compare_videos`/`picture_in_picture` `_batch`) | in-progress | — | normal | milestones/M32-batch-fan-in-verbs.md |
