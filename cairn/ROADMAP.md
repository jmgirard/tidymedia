...
_Last hygiene check: 2026-07-12 (M18 planned)_

## Milestones

| ID | Title | Status | Depends on | Priority | File/Archive |
|---|---|---|---|---|---|
| M18 | Graceful silent-input handling for two-pass loudnorm | planned | M16, M17 | normal | milestones/M18-silent-input-loudnorm.md |
