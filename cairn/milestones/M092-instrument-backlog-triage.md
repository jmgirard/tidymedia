...
6. *(confirmed, new)* **D072's closing rule says a logged instrument finding is
...
7. *(confirmed, new)* **D072 opens "held eight sections and 53 review findings"
...
8. *(confirmed, new)* **The work log's ROADMAP byte figure is off by 5.** The
...
12. *(confirmed, new, cosmetic)* **The ledger's `M080 F7` cell carries a stray
...
14. *(confirmed, new, cosmetic)* **`cairn/DECISIONS.md:3315` runs to 110
...
Findings 6, 7, 8, 12 and 14 are accuracy defects in this milestone's own durable
record (D072 and the work log) and are the fix-now candidates carried to the
approval gate. Findings 9, 10, 11 and 13 are recorded and rejected: 11 is
already discharged, 10 is not an AC1 failure and was addressed by the
compression, 9 has no writable target under IP4 beyond what D072 already says,
and 13 is a presentation preference over cells that satisfy the criterion.
