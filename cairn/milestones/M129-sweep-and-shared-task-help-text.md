...
- 2026-09-13: T3 done. The M129 ledger section in `cairn/references/plain-docs.md` records the base commit, the 34 domain pages, 11 AC4 identifiers on 9 pages, and the 33 repeated paragraphs. For the base sweep output (393 findings, 35 sentences printed on two or more pages), it records per-page counts by kind and the command that prints the full output again, not a paste of 393 lines.
