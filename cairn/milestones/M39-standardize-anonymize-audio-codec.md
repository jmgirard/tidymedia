...
- 2026-07-26: review — user elected at the merge gate to also fix F4 (the sub-threshold finding); NEWS now states the positional-argument shift. Second spelling NOTE ("positionally") reworded, `check()` back to `Status: OK`.
